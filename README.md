...
**clarior** is a premium, state-of-the-art Chrome Extension designed to eliminate documentation friction. When reading complex API docs, guides, or codebases, developers often run into confusing jargons, convoluted explanations, and dense paragraphs. **clarior** embeds an intelligent, non-destructive explanation layer right into your browser.

With **clarior**, you can instantly highlight any word, jargon, or paragraph to obtain clean, context-focused simplifications, and launch interactive deep-dives inside a gorgeous **Neon Noir** styled workspace.
...
*   **🧠 "Dig Deeper" Focus Mode**: As you simplify jargon on a page, **clarior** automatically lists them in a dedicated interactive list inside your sidebar. Click a topic pill to lock the AI's focus onto that specific topic and ask context-aware follow-up questions.
...
5.  Pin **clarior** to your browser toolbar!
6.  Click the glowing **clarior** logo, enter your name, add your Gemini API key, and hit **Continue** to start learning with absolute clarity.

---

## 🔑 Generating a Gemini API Key from Google AI Studio

To power **clarior**, you will need a free Gemini API key from Google AI Studio:
...
6. Copy your generated key and paste it directly into the **clarior** popup setup screen!

---

## 🚀 How to Use

Once **clarior** is loaded and your Gemini API key is configured, you're ready to read documentation with ease!
...
*   The **clarior interactive sidebar** will slide open, loaded with a chat interface to ask follow-up questions.
...
If you find any bugs, issues, or improvement ideas while using clarior, feel free to open an issue on GitHub. Your feedback and contributions are truly valuable and help make clarior better for everyone. 🚀

Whether it’s fixing a bug, suggesting a feature, improving UI/UX, or contributing code — every contribution matters. So do contribute and be part of building clarior together.

---

## ☕ Support clarior

If you love using **clarior** and want to support its ongoing development, feel free to support the developer directly! It keeps the lights on and the neon glowing.
